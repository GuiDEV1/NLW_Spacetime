...
export const metadata = {
  title: 'NWL SpaceTime',
  description: 'Uma ca´pusula do tempo constuída com React, Next.js, TailwindCSS e TypeScript',
}
  ...
  return (
    <html lang="pt-br">
      <body className={`${roboto.variable} ${baiJamjuree.variable} font-sans bg-gray-900 text-gray-100`}>
       ...
       {/* Left */}
      <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r bg-[url(../assets/bg-stars.svg)]">
          {/* blur */}
